...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.local.rkb.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.local.rkb.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            createCache(cm, com.local.rkb.domain.User.class.getName());
